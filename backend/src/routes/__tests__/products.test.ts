...
const mockNonAdminUser = (req: any, res: any, next: any) => {
  req.user = {
    id: 1,
    telegramId: '123',
    username: 'user',
...
const mockAdminUser = (req: any, res: any, next: any) => {
  req.user = {
    id: 2,
    telegramId: '456',
    username: 'admin',
...
describe('Products Routes RBAC', () => {
  ...
  describe('POST /api/products', () => {
    ...
    it('should return 403 for non-admin users', async () => {
      app.use('/api/products', mockNonAdminUser);
      ...
      expect(response.body.error.message).toBe('Требуются права администратора');
    });
    ...
    it('should succeed for admin users and return normalized images', async () => {
      ...
      app.use('/api/products', mockAdminUser);
      app.use('/api/products', productsRouter);
  ...
  describe('PUT /api/products/:id', () => {
    ...
    it('should succeed for admin users and return normalized images', async () => {
      const existingProduct = {
        ...
        description: 'Test description',
        price: 5000,
        images: JSON.stringify(['old1.jpg']),
        isActive: true,
        createdAt: new Date(),
        updatedAt: new Date(),
      };
      ...
      expect(mockPrisma.product.update).toHaveBeenCalledWith({
        ...
        data: {
          title: 'Updated Product',
          price: 6000,
          images: JSON.stringify(['updated1.jpg', 'updated2.jpg']),
        },
      });
    });
